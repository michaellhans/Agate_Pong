...
public class PlayerControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Jika pemain menekan tombol atas, beri kecepatan positif ke komponen y (ke atas)
        ...
        // Jika posisi raket melewati batas atas, kembalikan batas atas tersebut.
        if (position.y > yBoundary)
        {
            position.y = yBoundary;
        }
        // Jika posisi raket melewati batas bawah, kembalikan batas bawah tersebut.
